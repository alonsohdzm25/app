...
const routes: Routes = [
  ...
  { path: 'divulgacion-cientifica', component: AgregarDivulgacionCientificaComponent },
  { path: 'estancias', component: AgregarEstanciasComponent },
  { path: 'grados-academicos', component: AgregarGradosAcademicosComponent },
  { path: 'implementacion-tecnologica', component: AgregarImplementacionTecnologicaComponent },
  { path: 'libros', component: AgregarLibrosComponent },
  { path: 'obtencion-de-grados', component: AgregarObtencionGradosComponent },
  { path: 'patentes', component: AgregarPatentesComponent },
